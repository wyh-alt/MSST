...
```bash
usage: preset_infer_cli.py [-h] -p PRESET_PATH [-i INPUT_DIR] [-o OUTPUT_DIR] [-f {wav,mp3,flac}] [--debug]
...
```bash
python scripts/preset_infer_cli.py -p preset.json -i input_folder -o output_folder -f wav
```
